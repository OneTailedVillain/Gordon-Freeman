-- Generic serializer and deserializer for tables.
...
-- Make these functions as empty locals to resolve BLUA's inability to
-- Understand forward declarations... for some reason.
...
rawset(_G, "saveTableToFile", function(filePath, tbl, player)
	if not player then
		error("Function 'saveTableToFile' was called without a player argument!")
		return
	end
